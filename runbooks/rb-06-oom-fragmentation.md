...
- **分支 B(碎片)**:开启分配器可扩展段模式;根治靠减少形状抖动——序列分桶/packing(见 [第 16 章](../第四部分-训练系统/第16章-并行策略.md));**不要**为碎片堆 ZeRO-3/offload,为碎片付 30% 吞吐代价是最常见的浪费([§17.4.8](../第四部分-训练系统/第17章-显存与训练侧精度机制.md#1748-显存-oom-的系统性排查))。
