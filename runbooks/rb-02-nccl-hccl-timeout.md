...
- 训练侧指标采集口径见 [§29.2.4](../第七部分-工程化与治理/第29章-可观测性与评测流水线.md#2924-训练侧可观测性与告警设计)。
...
- **入池门禁**:节点上线/归还前必跑点对点与小规模集合通信基准,不达标不入池([§8.4.6](../第二部分-算力底座/第08章-K8s上的加速卡.md#846-节点生命周期驱动健康检查与自动隔离))。
