...
- 抢占率(preemption rate)从常态的接近零飙升并持续高位;KV 池水位长期贴着上限运行(两个指标的定义见 [§22.2.3](../第五部分-推理系统/第22章-推理引擎原理.md#2223-优先级抢占与请求驱逐) 与 [§22.1](../第五部分-推理系统/第22章-推理引擎原理.md#221-kv-cache-与显存),采集点见 [§29.2.1](../第六部分-上层平台/第29章-可观测性与评测流水线.md#2921-llm-专属指标体系定义采集点与误用))。
