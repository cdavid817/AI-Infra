...
- **生态人月是第一变量**:硬件差价看得见,适配、对标、双份 CI、双份值守的人力看不见——[§12.7](../第二部分-算力底座/第12章-国产算力平台与异构迁移.md#127-生态作为选型变量全书唯一定义处) 的核心就是把它折成钱进同一张表,本架构的成本模型必须常年维护这张表;
- **国产卡 TCO 的正确算法**:按等效算力(实测 MFU 折算)而非卡数比价,电费按实际功耗与 PUE 入账([§31.3.2](../第七部分-工程化与治理/第31章-容量、成本与SLO.md#3132-国产卡在-tco-模型里的正确算法));
- **准入流程本身的成本**:每个负载 2~6 周的评估工期(E.1~E.4,[§12.3](../第二部分-算力底座/第12章-国产算力平台与异构迁移.md#123-迁移评估方法论两周出结论))是门票钱,负载越碎门票越亏——这直接推出"长尾负载不准入"的运营纪律;
