...
| FP16 | 2 | ±65504(5 位指数) | ~3 位 | Volta 起;各家普遍支持 | 推理;训练需 loss scaling([§17.4](../第四部分-训练系统/第17章-显存与训练侧精度机制.md#174-方案对比显存不够的三条路线)) |
...
| FP8 E5M2 | 1 | ±57344 | <1 位 | 同上 | 梯度(要范围不要精度);scaling 策略见 [§17.4](../第四部分-训练系统/第17章-显存与训练侧精度机制.md#174-方案对比显存不够的三条路线) |
