...
本台账用于区分“来源已知”与“允许正式发布”。`待确认` 表示图片只可用于草稿审阅；正式发布前必须确认论文许可证、署名要求和是否需要作者授权，或改为自绘示意图。

| 文件 | 使用位置 | 原始来源 | 原始图号 | 当前许可证记录 | 发布状态 |
|---|---|---|---|---|---|
| `pagedattention-block-table.png` | 第 22 章 | Kwon et al., *Efficient Memory Management for LLM Serving with PagedAttention*, arXiv:2309.06180 | Figure 6 | CC BY 4.0（需发布前复核） | 待确认 |
| `pagedattention.png` | 第 22 章 | Kwon et al., *Efficient Memory Management for LLM Serving with PagedAttention*, arXiv:2309.06180 | Figure 5 | CC BY 4.0（需发布前复核） | 待确认 |
